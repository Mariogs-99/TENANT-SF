...
public class Identificacion implements Serializable
{
    ...
    @NotNull
    public final Integer version = 3;
    /**
     * Ambiente de destino
     * (Required)
     * 
    ...
    @NotNull
    public final String tipoDte = "06";
    /**
     * Número de Control
     * (Required)
     * 
    ...
    @Pattern(regexp = "^DTE-06-[A-Z0-9]{8}-[0-9]{15}$")
    @Size(min = 31, max = 31)
    @NotNull
    ...
    @NotNull
    public Identificacion.TipoMoneda tipoMoneda;
    private final static long serialVersionUID = -6257594754111401097L;
    ...
    public enum TipoContingencia {
        ...
        private final static Map<Integer, TipoContingencia> CONSTANTS = new HashMap<Integer, TipoContingencia>();
    ...
    public enum TipoModelo {
        ...
        DIFERDIO(2);
        private final Integer value;
        private final static Map<Integer, TipoModelo> CONSTANTS = new HashMap<Integer, TipoModelo>();
        ...
        @JsonCreator
        public static TipoModelo fromValue(Integer value) {
