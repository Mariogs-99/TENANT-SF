...
public class Identificacion implements Serializable
{
    ...
    @NotNull
    public final String tipoDte = "11";
    /**
     * Número de Control
     * (Required)
     * 
    ...
    @Pattern(regexp = "^DTE-11-[A-Z0-9]{8}-[0-9]{15}$")
    @Size(min = 31, max = 31)
    @NotNull
    ...
    @JsonPropertyDescription("Tipo de Contigencia")
    @NotNull
     ...
     * 
     */
    @JsonProperty("motivoContigencia")
    ...
    private final static long serialVersionUID = 8110807026966891753L;
    ...
    public enum TipoModelo {
        ...
        public static TipoModelo fromValue(Double value) {
            TipoModelo constant = CONSTANTS.get(value.intValue());
            if (constant == null) {
                throw new IllegalArgumentException((value +""));
            } else {
                return constant;
